...
class HumanoidEnv(MujocoEnv, utils.EzPickle):
    ...
    def reward(self):
        ...
        # Stability reward
        r_stability = 0.0
        if phase >= 0.9 and phase <= 1.0:  # Landing phase
        ...
        elif 0.42 <= phase < 0.9:  # Flight phase
        ...
        r_upright = 0.0
        if phase > 1.0:  # Post-landing phase
            ...
            r_upright = 0.4 * r_torso + 0.3 * r_knee + 0.2 * r_hip + 0.1 * r_com_vel
