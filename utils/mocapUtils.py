...
PARAMS_KP_KD = {
    "chest": [1000, 100], "neck": [100, 10], 
    "right_shoulder": [400, 40], "right_elbow": [300, 30], 
    "left_shoulder": [400, 40], "left_elbow": [300, 30], 
    "right_hip": [300, 30], "right_knee": [300, 30],  # Reduced from 500, 50
    "right_ankle": [200, 20],  # Reduced from 400, 40
    "left_hip": [300, 30], "left_knee": [300, 30],  # Reduced from 500, 50
    "left_ankle": [200, 20]  # Reduced from 400, 40
}
...
PARAMS_KP_KD_TOE = {
    ...
    "left_hip": [300, 30], "left_knee": [300, 30],  # Reduced from 500, 50
    "left_ankle": [200, 20],  # Reduced from 400, 40
    "right_toe": [200, 20], "left_toe": [200, 20]
}
